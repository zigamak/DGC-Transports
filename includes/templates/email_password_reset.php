<div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; background-color: #f8f9fa;">
    ...
    <div style="padding: 30px; background: white;">
        ...
        <p>You have requested to reset your password for <?php echo SITE_NAME; ?>.</p>
        <p>Please click the button below to reset your password:</p>
        <div style="text-align: center; margin: 20px 0;">
            <a href="<?php echo SITE_URL; ?>/reset_password.php?token=<?php echo htmlspecialchars($reset_data['token']); ?>" style="background: #dc2626; color: white; padding: 10px 20px; border-radius: 5px; text-decoration: none; display: inline-block;">Reset Password</a>
        </div>
