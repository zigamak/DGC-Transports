...
if ($num_seats !== $trip['num_seats']) {
    // Redirect back to seat selection if mismatch
        ...
        <div class="max-w-6xl mx-auto px-4">
            ...
            <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
                ...
                <div class="lg:col-span-2">
                    <form id="passengerForm" action="process_booking.php" method="POST" class="space-y-6">
...
function goBack() {
    if (confirm('Are you sure you want to go back? Your seat selection will be cleared.')) {
        fetch('clear_seats.php', { method: 'POST' })
            .then(() => {
